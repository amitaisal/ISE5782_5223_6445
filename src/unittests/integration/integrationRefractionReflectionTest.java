...
public class integrationRefractionReflectionTest {
    ...
    public void bookShelf() {
        Material rBookMat = new Material().setKd(0.5).setKs(0.2).setNShininess(30);
        Material yBookMat = new Material().setKd(0.5).setKs(0.2).setNShininess(30);
        Material gBookMat = new Material().setKd(0.5).setKs(0.2).setNShininess(30);
